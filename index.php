...
<head>
    <title><? echo lang('welcome'); ?> | Bootcamp</title>
    <meta charset="UTF-8">
    <meta name="description" content="Bootcamp is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,Bootcamp,meet,free platform">
    <meta name="author" content="mollick">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Bootcamp</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Bootcamp</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('wallstant_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="Bootcamp" style="width: 300px;" />
                </div>
            </div>
        </div>
